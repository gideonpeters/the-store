<template>
    <div class="p-5">
        <div class="row justify-content-center">
            <div class="col-md-3 col-6 ml-5" v-for="product in products" :key="product.id">
